...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         * 3. 리턴은 한 개의 값만 가능하기 때문에 회원정보를 묶어서 리턴값으로 사용할 수 없다.
         * (서로 다른 자료형이기 때문)
         * */
         ...
         * 아이디, 비밀번호, 이름, 나이, 성별, 취미를 연손된 메모리 주소에 사용하도록 heap에 공간을 만들었다.
         *
         * */
        ...
        member.age = 20;
        member.gender = '여';
        member.hobby = new String[]{"축구", "야구", "농구"}; // 배열 설정
        ...
        for(int i = 0 ; i< member.hobby.length; i++){ //member class의 hobby를 끌어 쓸 것이기 때문에
