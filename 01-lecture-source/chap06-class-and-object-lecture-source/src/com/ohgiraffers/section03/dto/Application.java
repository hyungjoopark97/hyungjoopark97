...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        //행위 위주로 메소드를 추상화했는데,데이터 위주인 DTO라는 것이 있다.
        ...
        //setter 설정자를 이용해서 내용을 입력한다.

        MemberDTO memberDTO = new MemberDTO();
        memberDTO.setNumber(1);
        memberDTO.setName("박형주");
        memberDTO.setAge(20);
        memberDTO.setGender('남');
        memberDTO.setHeight(177);
        memberDTO.setActived(true);

        //getter 접근자를 이용해서 내용을 불러온다.
        ...
        System.out.println("회원활성화 여부 : " + memberDTO.isActived());
