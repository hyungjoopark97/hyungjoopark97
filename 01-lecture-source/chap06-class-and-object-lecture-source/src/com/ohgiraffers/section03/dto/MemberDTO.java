...
public class MemberDTO {
    ...
    private boolean isActived; // 회원 활성화 여부
     ...
     *  [표현식]
     *  public void set필드명(매개변수) { //인자를 받아서 값을 넣어줘야 하기에 매개변수가 필요함
     *      필드 = 매개변수;
     *  }
     *  [작성예시]
    ...
    public void setActived(boolean actived) {
        isActived = actived; //boolean만 this가 아님. is 그 자체가 표기법이다.
    }
    ...
    public boolean isActived() {
        ...
        //boolean의 접근자는 get으로 시작하지 않고 is로 시작하는 것이 관례이다.
