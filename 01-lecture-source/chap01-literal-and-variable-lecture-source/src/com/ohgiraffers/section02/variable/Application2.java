...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 1-1-4 문자열을 취급하는 자료형*/
        String str;        //4byte(엄밀히 이야기하면 주소값은 4byte 정수값) //주소값은 자료형의 크기만큼 메모리를 할당하는 것이다.
        ...
        bnum = 1; //-128~ +127
        snum = 2; // -32768~ 32767
        inum = 4; // -2147483648~2147483647
        //lnum = 8; // 아무 문제 없을 것 같지만 뒤에 대문자 L을 붙여야합니다. 그 이유는 형변환에서 알려드립니다. -9223342036854775808 ~ 9223372036854775807
        lnum = 8L;

        /* 2-2. 실수를 취급하는 자료형 값 대입 */
        // fnum = 4.0; float는 뒤에 소문자 f를 붙여줘야 함
        fnum = 4.0f;
        dnum =  8.0;

        /* 2-3 문자를 취급하는 자료형 값 대입*/
        ch =  'a';   //문자 형태의 값을 저장할 수 있다.
        ch2 = 97; //'a'는 아스키코드상 '97'이라는 숫자이기 때문에 저장할 수 있다.
        ...
        * */
        ...
        System.out.println("bnum의 값 출력 : " + snum );
        System.out.println("bnum의 값 출력 : " + inum );
        System.out.println("bnum의 값 출력 : " + lnum );

        System.out.println("fnum의 값 출력 : " + fnum );
        System.out.println("bnum의 값 출력 : " + dnum );
