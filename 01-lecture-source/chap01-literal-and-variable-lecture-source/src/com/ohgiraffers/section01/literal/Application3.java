...
public class Application3 {
    ...
    public static void main (String[] args){
        ...
        /*수업목표 문자열 합치기 결과를 예측하고 사용할 수 있따. */
        /*목차 1. 두 개의 문자열 합치기 */
        ...
        System.out.println(9 + "9" + 9); //999  // 왼쪽의 연산부터 수행하고 수행 결과를 오른쪽과 연산함
        System.out.println(9 + 9 + "9"); //189  // +연산방향은 왼쪽에서 오른쪽이다. (숫자부터 합쳐짐)(문자열)
        ...
        System.out.println( "10과 20의 차 : " + (10 - 20 )); // 문자열은 마이너스 연산이 불가능하기에 문자열과 마이너스는 연산이 불가능하다 (반드시 괄호 사용)
