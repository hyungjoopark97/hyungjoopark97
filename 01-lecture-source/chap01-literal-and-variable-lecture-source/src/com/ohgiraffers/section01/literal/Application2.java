...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        System.out.println(3 / 2); //정수와 정수의 연산이기에 실수값인 소숫점이 나오지않음
        ...
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0); //실수와 실수의 값에서는 약간의 오차가 생깁니다.
        ...
        /* 지금은 계산 결과가 왜 이렇게 나왔는지 보다 연산이 가능하다는 사실에 집중하자 */
        ...
        /* 2-2 문자와 정수의 연산 */
        /* 문자에 정수를 연산하는 것도 아능하다.*/
        /*
        * 이쯤 되면 'a'는 97과 같다라는 것을 알 수 있다.
        * 컴퓨터는 문자를 인식하지 못하고 숫자로만 인식할 수 있기 때문에 모든 문자에 대응되는 숫자를이 매칭되어있다.
        * 아스키코드와 유니코드
        * */
        ...
        /*3-2-2 문자열과 실수의 연산*/
        System.out.println("helloworld" + 1.245663);
        /*3-2-3 문자열과 문자의 연산 */
...
*/ //에러발생
        ...
        System.out.println(true % 0.11);*/     //에러발생
       ...
       /* System.out.println(true + 'a');
        ...
        /* 이유은 위에서 테스트해본 문자열 합치기가 되는 원리와 동일하다 */
        System.out.println("==========논리와 문자열의 연산============");
        System.out.println(true + "a"); // 문자열 합치기가 됩니다.
        // System.out.println(true - "a");
        // System.out.println(true * "a");
        // System.out.println(true / "a");
        // System.out.println(true % "a");
