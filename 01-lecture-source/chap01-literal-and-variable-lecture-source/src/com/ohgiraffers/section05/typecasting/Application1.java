...
public class Application1 {
    public static void main(String[] arg){
        ...
        * */
        /*형변환의 종류와 규칙
        * 1. 자동형변환 (묵시적 형변환) : 컴파일러가 자동으로 수정해주는 타입 변환
        *   1-1. 작은 자료형에서 큰 자료형으로 자동형변환이 된다.
        *   1-2. 정수는 실수로 자동형변환이 된다.
        *   1-3. 문자형은(char)은 int형으로 자동형변환이 된다.
        *   1-4. 논리형은 형변환규칙에서 제외된다.
        *
        ...
        * */
        ...
        System.out.println("fnum + dnum : "+ result2);

        /* 1-2 정수는 실수로 자동형변환 된다. */
        /* 정수를 실수로 변경할 때 소수점자리수가 없어도 실수형태로 표현이 가능하다. 이 때 데이터 손실이 없기 때문에 자동형변환이 가능하다.*/

        /* 1-3 문자형은 int형으로 자동 형변환이 된다.(유니코드와 아스키코드로 인해) */
        char ch1 = 'a';
        int num11 = ch1;
