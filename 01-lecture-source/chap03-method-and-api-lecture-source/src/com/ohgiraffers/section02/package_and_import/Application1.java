...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 그렇기 때문에 서로 다른 패키지에 클래스를 사용하는 경우에는 클래스명 앞에 패키지명을 명시해서 풀 클래스 네임으로 사용해야 한다.
        *
        * */

        /*1. non- static 메소드의 경우 */
        com.ohgiraffers.section01.method.Calculator cal = new com.ohgiraffers.section01.method.Calculator();  // 이렇게 선언하면 사용할 수 있다.
