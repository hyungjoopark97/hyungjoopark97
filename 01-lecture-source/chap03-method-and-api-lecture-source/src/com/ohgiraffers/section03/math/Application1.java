...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 모든 소스 코드를 윌가 다 외울 수 없으니 API문서를 별도로 제공해주고 있다.
        * */

        /*
        * java.lang.Math
        * Math 클래스는 수학에서 자주 사용하는 상수들과 함수율을 미리 구현해놓은 클래스이다.
        ...
        * (객체의 상태를 관리하지 않고 기능만을 제공하는 경우 메모리를 효율적으로 사용하기 위해 자주 사용되는 기법이다.) */
        ...
        /* 1-2 import 를 해서 사용 */ // Math는 이미 임포트 되어있는상태이기 때문에 하지 않아도 됨
        System.out.println("1.25의 절대값 : " + (Math.abs(1.25)));

        /* 2-1. 최대값, 최소값 출력 */
        System.out.println("10과 20중 더 작은 것은? : " + Math.min(10,20));
        System.out.println("20과 30중에 더 큰 것은? : " + Math.max(20,30));

        System.out.println("원주율 :  " + Math.PI);

        /* 3. 난수 출력 */
        System.out.println("난수 발생 : " + Math.random());
        //난수 발생 : 0.07436794078514752
        //난수 발생 : 0.011813327369780469
