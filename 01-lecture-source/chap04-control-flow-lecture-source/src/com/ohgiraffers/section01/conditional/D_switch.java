...
public class D_switch {
    ...
    public void testSimpleSwitchStatement(){
        ...
        int snum = sc.nextInt();
        System.out.println("연산 기호 입력 : (+, - , /, %) : ");  //변수 설정이 안되기 때문에 미리 설정
        char op = sc.next().charAt(0);        //첫번째 글자만 가져오기
    ...
    public void testSwitchVendingMachine(){
        ...
        /* 수업목표. switch문 내에 break 문에 대해 흐름을 이해하고 적용할 수 있다. */
        /* switch 문을 이용하여 문자열 값 비교 및 break문 테스트*/
        /*
        * 1. JDK 1.7 이상부터 switch문을 사용하여 문자열을 바교할 수 있다.
