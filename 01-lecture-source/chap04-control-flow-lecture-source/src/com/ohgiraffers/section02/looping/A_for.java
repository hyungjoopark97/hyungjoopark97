...
public class A_for {
    ...
    public void testSimpleForStatement() {
        ...
        /* 수업목표. for 단독사용에 대한 흐름을 이해하고 적용할 수 있다. */
        /*
         * [for문 표현식]
         * for(초기식; 조건식; 증감식){
    ...
    public void testForExample1() {
        /*우리가 뭘 반복하는지 확인하며 반복문으로 개선할 수 있다.*/
        /* 10명의 학생의 이름을 입력 받아 이름을 출력해보자 */

        Scanner sc = new Scanner(System.in);

        System.out.print("1번 학생의 이름을 입력해주세요 : ");
    ...
    public void testForExample3() {
        ...
        int random = (int) (Math.random() * 6) + 5; //범위를 지정해줌
    ...
    public void printSimpleGuGudan() {
        ...
        /* 수업목표. 무엇을 반복하는지 확인하며 반복문으로 개선할 수 있다.*/
        /*
         * 기보드로 2~9사이에 구구단을 입력받아
        ...
        if (dan >= 2 && dan <= 9) {
            ...
            System.out.println("반드시 2~9사이의 양수를 입력하셔야 합니다.");
