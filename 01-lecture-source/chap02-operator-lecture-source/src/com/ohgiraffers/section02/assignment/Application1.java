...
public class Application1 {
    public static void main(String[] args){
        ...
        * '*=' : 왼쪽의 피여산자에 오른쪽의 피연산자를 곱한 결과를 왼쪽의 피연산자에 대입함
        * '/=' : 왼족의 피연산자에 오른쪽의 피연산자를 나눈 결과를 왼쪽의 피연산자에 대입함
        ...
        * */
        ...
        // 3증가시
        num = num + 3;    // 대입연산자의 오른쪽은 값 왼쪽은 공간을 말한다.

        System.out.println("num : " + num);
        num += 3;     // num = num+3;과 같은 의미입니다.
