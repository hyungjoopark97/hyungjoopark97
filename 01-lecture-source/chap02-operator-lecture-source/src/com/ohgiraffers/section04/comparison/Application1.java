...
public class Application1 {
    public static void main(String[] args){
        ...
        * 연산자 중 참 혹은 거짓을 반환하는 연산자는 심항연산자의 조건식이나 조건문의 조건절에 많이 사용된다
        * (충분히 연습이 필요함!)
        * */
        ...
        * */
        ...
        System.out.println("inum1과 inum2가 같지 않은지(다른지) 비교 : " + (inum1!=inum2));
        System.out.println("inum1이 inum2보다 큰지 비교 : " + (inum1 > inum2));
        System.out.println("inum1이 inum2보다 크거나 같은지 비교 : " + (inum1>=inum2));
        System.out.println("inum1보다 inum2가 큰지 비교 : " + (inum1<inum2));
        System.out.println("inum1보다 inum2가 크거나 같은지 비교 : " + (inum1<=inum2));
        ...
        System.out.println("dnum1과 dnum2가 같지 않은지(다른지) 비교 : " + (dnum1!=dnum2));
        System.out.println("dnum1이 dnum2보다 큰지 비교 : " + (dnum1 > dnum2));
        System.out.println("dnum1이 dnum2보다 크거나 같은지 비교 : " + (dnum1>=dnum2));
        System.out.println("dnum1보다 dnum2가 큰지 비교 : " + (dnum1<dnum2));
        System.out.println("dnum1보다 dnum2가 크거나 같은지 비교 : " + (dnum1<=dnum2));

        /* 2. 문자값 비교 */
        char ch1 = 'a';     //아스키코드상 숫자로 인식하기 때문에 비교가 가능하다.
        char ch2 = 'A';

        System.out.println("==========문자값 비교==========");
        System.out.println("ch1과 ch2가 같은지 비교 : " + (ch1==ch2));
        System.out.println("ch1과 ch2가 같지 않은지(다른지) 비교 : " + (ch1!=ch2));
        System.out.println("ch1이 ch2보다 큰지 비교 : " + (ch1 > ch2));
        System.out.println("ch1이 ch2보다 크거나 같은지 비교 : " + (ch1>=ch2));
        System.out.println("ch1보다 ch2가 큰지 비교 : " + (ch1<ch2));
        System.out.println("ch1보다 ch2가 크거나 같은지 비교 : " + (ch1<=ch2));

        /* 3. 논리값 비교 */
        /* ==과 !=는 가능하지만 대소비교는 불가능하다 */
        boolean bool1 = true;
        boolean bool2 = false;

        System.out.println("==========논리값 비교==========");
        System.out.println(" bool1과 bool2가 같은지 비교 : " + ( bool1==bool2));
        System.out.println(" bool1과 bool2가 같지 않은지(다른지) 비교 : " + ( bool1!=bool2));
        ...
        boolean result = x <= y;    // 대입연산자이기에 논리값이 아닌 연산이며, boolean으로 정해줘야 한다.
