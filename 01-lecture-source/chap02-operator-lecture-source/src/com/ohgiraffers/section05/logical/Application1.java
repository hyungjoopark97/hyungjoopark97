...
public class Application1 {
    public static void main(String[] args) {
        ...
        *
        * 논리연산자의 종류
        * 1. 논리 연결 연산자 : 두 개의 피연산자를 가지는 이항 연산자이며, 연산자의 결함 방향은 왼족에서 오른쪽이다.
        *                  : 두 개의 논리 식을 판단하여 참과 거짓을 판단한다.
        *
        * 1-1. &&(논리AND) 연산자 : 두 개의 논리식이 모두 참일 경우 참을 반환 둘 중에 한 개라도 거짓인 경우 거짓을 반환하는 연산자이다.
        * 1-2. ||(논리OR) 연산자 : 두 개의 논리식 중 둘 중 하나라도 참인 경우 참을 반환 둘 다 겨짓일 경우 거짓을 반환하는 연산자이다.
        *
