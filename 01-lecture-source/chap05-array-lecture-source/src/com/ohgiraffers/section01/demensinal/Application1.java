package com.ohgiraffers.section01.demensinal;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 배열의 주소를 관리하는 배열의 길이는 앞부분에 정수형으로 표기하며 반드시 크기를 지정해주어야 한다.
        * */

        //iarr = new int[][];  //크기를 지정해주지 않았기에 에러가 발생한다.
       //iarr = new int [][5];   // 주소를 묶어서 관리할 배열의 크기를 지정하지 않으면 에러발생
        iarr = new int[3][];

        /* 3. 각 인덱스에 관리하는 배열을 할당하여 주소를 보관하는 배열에 저장 */

        iarr[0] = new int[5];
        iarr[1] = new int [5];
        iarr[2] = new int [5];

        //3개를 만들었기에 iarr[3]는 에러가 남

        // 한번에 할당도 가능

        iarr2 = new int [3][5];
        //3개의 배열에 5개의 인덱스를 할당할거야
        // 같지 않을 경우 가변배열이라고 한다.

        //4. 출력에는 두 가지 방법이 있음.

        /*4-1. 첫 번째 방법은 배열을 하나씩 접근해서 출력하기 */
...
/*3개의 방을 만들어줫으니 3번 반복함 */

        /* 4-2 중첩 for문을 이용해서 배열값을 출력*/
