...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = new int[5];
        iarr[2] = arr; //이와 같이 미리 할당해둔 배열을 활용할 수 있다.
...
/*
        ...
        //가변배열과 정변배열의 출력 자체는 같음. 반복문을 많이 사용한다.
